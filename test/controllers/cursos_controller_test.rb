...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { curso_ano: @curso.curso_ano, curso_id: @curso.curso_id, curso_nombre: @curso.curso_nombre, curso_semestre: @curso.curso_semestre }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { curso_ano: @curso.curso_ano, curso_id: @curso.curso_id, curso_nombre: @curso.curso_nombre, curso_semestre: @curso.curso_semestre }
    assert_redirected_to curso_path(assigns(:curso))
  end
